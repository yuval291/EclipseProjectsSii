...
public class AvailabilityService {
	...
	public String getSystemStatus(SystemRepository<DataResponse> repo) throws IOException {
		
		List<DataResponse> allSystems = repo.findAll();
	...
	public int httpConnection(DataResponse sys) {
