...
//	    return JobBuilder.newJob(SystemJob.class).withIdentity("systemjob", "job-group").build();
//	}
//	
//	@Bean
//	public static Trigger trigger(JobDetail job) {
//	    return  TriggerBuilder.newTrigger().forJob(job).withIdentity("simpleTrigger", "trigger-group")
